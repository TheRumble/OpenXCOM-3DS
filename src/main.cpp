...
{
#ifdef NINTENDO_3DS
	OpenXcom::System3DS::enableNew3DSSpeedup();
#endif
...
#ifdef NINTENDO_3DS
	Display3DS::applyBaseResolution();
#else
...
#ifdef NINTENDO_3DS
	/*
	 * APT is waiting for the application process to terminate.
	 * Avoid lengthy or potentially blocking desktop-style cleanup.
	 */
	System3DS::shutdownGlobeShadowWorker();
	System3DS::shutdownAudio();
	return EXIT_SUCCESS;
#endif
