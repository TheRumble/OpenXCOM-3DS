...
public:
	...
	/// Sets whether controller Cancel may leave this field.
	void setCancelAllowed(bool allowed) { _cancelAllowed = allowed; }
	/// Gets whether controller Cancel may leave this field.
	bool isCancelAllowed() const { return _cancelAllowed; }
