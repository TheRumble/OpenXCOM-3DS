...
InfoboxOKState::InfoboxOKState(const std::string &msg)
{
	...
	/*
	 * Extend the message area and keep the OK button against the
	 * same relative bottom edge as the original 144-pixel viewport.
	 */
	_frame = new Frame(
		261,
		89 + removedBattleBarHeight,
		30,
		48);
	_btnOk = new TextButton(
		...
		18,
		100,
		112 + removedBattleBarHeight);
	_txtTitle = new Text(
		255,
		61 + removedBattleBarHeight,
		33,
		51);
