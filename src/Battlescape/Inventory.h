...
#ifdef __3DS__
	/*
	 * OXCE_3DS_INVENTORY_PLACEMENT_PREVIEW
	 */
	Surface *_placementPreview3DS = nullptr;
#endif
...
#ifdef __3DS__
	/// Updates the 3DS valid/invalid carried-item footprint.
	void updatePlacementPreview3DS();
#endif
...
public:
	...
	/// 3DS helper: quick-moves item under cursor, or drops held item.
	bool quickMoveItemAt3DS(int absoluteX, int absoluteY);
