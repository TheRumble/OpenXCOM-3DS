...
protected:
	...
	bool _isHovered, _isFocused, _listButton, _menuNavigationEnabled, _tftdMode;
...
public:
	...
	void setMenuNavigationEnabled(bool enabled);
	/// Checks whether controller menu navigation may target this surface.
	bool isMenuNavigationEnabled() const;
