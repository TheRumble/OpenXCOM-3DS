...
void createOptionsOXC()
{
...
#ifdef NINTENDO_3DS
	/*
	 * Values are percentages unless otherwise noted. They are kept out
	 * of the normal Advanced list and will be exposed by Options3DSState.
	 */
	_info.push_back(OptionInfo(
		OPTION_OXC,
		"threeDSMenuCursorSpeed",
		&threeDSMenuCursorSpeed,
		100));
	...
	_info.push_back(OptionInfo(
		OPTION_OXC,
		"threeDSInvertGeoscapeCameraX",
		&threeDSInvertGeoscapeCameraX,
		false));

	_info.push_back(OptionInfo(
		OPTION_OXC,
		"threeDSInvertGeoscapeCameraY",
		&threeDSInvertGeoscapeCameraY,
		false));

	_info.push_back(OptionInfo(
		OPTION_OXC,
		"threeDSInvertBattlescapeCameraX",
		&threeDSInvertBattlescapeCameraX,
		false));

	_info.push_back(OptionInfo(
		OPTION_OXC,
		"threeDSInvertBattlescapeCameraY",
		&threeDSInvertBattlescapeCameraY,
		false));
	...
	_info.push_back(OptionInfo(OPTION_OXC, "battleDragScrollButton", &battleDragScrollButton, 0));
...
#ifdef NINTENDO_3DS
	_info.push_back(OptionInfo(OPTION_OXC, "geoDragScrollButton", &geoDragScrollButton, 0));
#elif defined(__MOBILE__)
...
#ifdef NINTENDO_3DS
	// Saved desktop settings must not override the fixed 3DS display.
	Display3DS::applyFixedDisplayOptions();
#endif
