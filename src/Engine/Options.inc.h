...
#ifdef NINTENDO_3DS
// Nintendo 3DS input and camera options.
OPT int threeDSMenuCursorSpeed;
OPT int threeDSGeoscapeCursorSpeed;
OPT int threeDSBattlescapeCursorSpeed;
OPT int threeDSInventoryCursorSpeed;

OPT int threeDSGeoscapeCameraSpeed;
OPT int threeDSBattlescapeCameraSpeed;

OPT bool threeDSInvertGeoscapeCameraX;
OPT bool threeDSInvertGeoscapeCameraY;
OPT bool threeDSInvertBattlescapeCameraX;
OPT bool threeDSInvertBattlescapeCameraY;

OPT int threeDSTouchpadSensitivity;
OPT int threeDSTouchpadDragThreshold;
OPT int threeDSTouchpadHoldDelay;
#endif
