...
#include <sys/types.h>
#include <pwd.h>
#if !defined(__CYGWIN__) && !defined(NINTENDO_3DS)
#include <execinfo.h>
#endif
#include <cxxabi.h>
#ifndef NINTENDO_3DS
...
#ifdef NINTENDO_3DS
	static constexpr const char *N3DS_ROOT =
		"sdmc:/3ds/OXCE/";
	static constexpr const char *N3DS_USER =
		"sdmc:/3ds/OXCE/user/";
#endif
...
# else /* __NO_DBGHELP */
	Log(LOG_FATAL) << "Unfortunately, no stack trace information is available";
# endif
#elif defined(__CYGWIN__) || defined(NINTENDO_3DS)
	Log(LOG_FATAL) << "Unfortunately, no stack trace information is available";
