...
void FlcPlayer::SDLPolling()
{
	...
	/* OXCE_3DS_A_SKIP_FLC
	 *
	 * FLC playback owns a blocking loop, so the normal 3DS input
	 * pump is not running here. Poll the hardware directly and feed
	 * A into the player's existing SKIPPED state.
	 */
	hidScanInput();
