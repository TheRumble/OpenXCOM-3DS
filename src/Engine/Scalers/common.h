...
/*
 * The normal HQX implementation uses a 64 MiB lookup table containing
 * every possible 24-bit RGB value. That is excessive for the 3DS.
 * Calculate the value only when an HQX scaler actually requests it.
 */
