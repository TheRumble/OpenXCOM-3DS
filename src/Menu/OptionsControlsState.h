...
#ifdef NINTENDO_3DS
	/* OXCE_3DS_BINDING_STATE_DECLARATIONS */
	/// Reports whether the Controls page is waiting for a key.
	static bool isWaitingForKey3DS();
	/// Cancels the current key-selection operation.
	static void cancelKeyBinding3DS();
        /// Assigns a virtual-keyboard binding without broadcasting it.
        static bool assignKey3DS(SDLKey key);
#endif
};
