...
#ifdef NINTENDO_3DS
    /* OXCE_3DS_GEOSCAPE_LAYOUT */
    /* Keep one camera-speed setting under the dedicated 3DS page. */
    _txtClockSpeed->setX(94);
    _txtClockSpeed->setY(24);
    _slrClockSpeed->setX(94);
    _slrClockSpeed->setY(34);

    _txtDogfightSpeed->setX(206);
    _txtDogfightSpeed->setY(24);
    _slrDogfightSpeed->setX(206);
    _slrDogfightSpeed->setY(34);

    _txtGlobeDetails->setX(94);
    _txtGlobeDetails->setY(68);
    _btnGlobeCountries->setX(94);
    _btnGlobeCountries->setY(78);
    _btnGlobeRadars->setX(94);
    _btnGlobeRadars->setY(96);
    _btnGlobePaths->setX(94);
    _btnGlobePaths->setY(114);

    _txtOptions->setX(206);
    _txtOptions->setY(68);
    _btnShowFunds->setX(206);
    _btnShowFunds->setY(78);
#endif
...
#ifdef NINTENDO_3DS
    /* OXCE_3DS_GEOSCAPE_HIDE_DESKTOP_SCROLL */
    /* Globe movement is configured through the dedicated 3DS page. */
    Options::geoDragScrollButton = 0;
