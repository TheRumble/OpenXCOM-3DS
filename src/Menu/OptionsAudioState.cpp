...
#ifdef NINTENDO_3DS
    /* OXCE_3DS_AUDIO_FINAL_LAYOUT */
    /* Balanced two-by-two layout for useful 3DS controls. */
    _txtMusicVolume->setX(94);
    _txtMusicVolume->setY(40);
    _slrMusicVolume->setX(94);
    _slrMusicVolume->setY(50);

    _txtSoundVolume->setX(206);
    _txtSoundVolume->setY(40);
    _slrSoundVolume->setX(206);
    _slrSoundVolume->setY(50);

    _txtUiVolume->setX(94);
    _txtUiVolume->setY(82);
    _slrUiVolume->setX(94);
    _slrUiVolume->setY(92);

    _txtVideoFormat->setX(206);
    _txtVideoFormat->setY(82);
    _cbxVideoFormat->setX(206);
    _cbxVideoFormat->setY(92);
#endif
	centerAllSurfaces();
...
#ifdef NINTENDO_3DS
    /* OXCE_3DS_AUDIO_FINAL_VISIBILITY */
    _txtMusicFormat->setVisible(false);
    _cbxMusicFormat->setVisible(false);
    _txtCurrentMusic->setVisible(false);

    _txtSoundFormat->setVisible(false);
    _cbxSoundFormat->setVisible(false);
    _txtCurrentSound->setVisible(false);

    _txtOptions->setVisible(false);
    _btnBackgroundMute->setVisible(false);

    _cbxMusicFormat->setMenuNavigationEnabled(false);
    _cbxSoundFormat->setMenuNavigationEnabled(false);
    _btnBackgroundMute->setMenuNavigationEnabled(false);
#endif
}
