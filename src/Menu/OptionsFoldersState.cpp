...
#ifdef NINTENDO_3DS
	/* OXCE_3DS_FOLDERS_INFORMATIONAL_PATHS */
	/* SD-card paths are displayed for reference only. */
	_txtDataFolderPath1->setMenuNavigationEnabled(false);
	_txtDataFolderPath2->setMenuNavigationEnabled(false);
	_txtUserFolderPath->setMenuNavigationEnabled(false);
	_txtSaveFolderPath->setMenuNavigationEnabled(false);
	_txtConfigFolderPath->setMenuNavigationEnabled(false);
#else
