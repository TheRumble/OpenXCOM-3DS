...
#ifdef NINTENDO_3DS
	// OXCE_3DS_GEOSCAPE_POPUP_CENTER_MISSIONDETECTEDSTATE
	/*
	 * This popup was positioned for the original 256-pixel
	 * Geoscape area. Center it on the full 320-pixel top screen.
	 */
