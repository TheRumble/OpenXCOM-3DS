...
#ifdef NINTENDO_3DS
	/// Returns true when this expanded dogfight has snap controls.
	bool hasNavigationControls3DS() const;
	/// Finds a spatial navigation target inside this dogfight.
	bool findNavigationTarget3DS(
			int directionX,
			int directionY,
			int cursorX,
			int cursorY,
