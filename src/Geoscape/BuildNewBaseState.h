...
private:
#ifdef NINTENDO_3DS
	static BuildNewBaseState *_active3DS;
#endif
	Base *_base;
	Globe *_globe;
...
public:
	...
	~BuildNewBaseState();
#ifdef NINTENDO_3DS
	/// Returns the currently constructed base-placement state.
	static BuildNewBaseState *getActive3DS();
	/// Returns the globe controlled by this placement state.
	Globe *getGlobe3DS() const;
#endif
	/// Resets globe.
	void init() override;
	/// Runs the timer.
