...
#ifdef NINTENDO_3DS
	// OXCE_3DS_CONFIRM_LANDING_CENTER
	_window->setX(_window->getX() + 32);
	_btnYes->setX(_btnYes->getX() + 32);
	_btnNo->setX(_btnNo->getX() + 32);
	_txtMessage->setX(_txtMessage->getX() + 32);
	_txtBegin->setX(_txtBegin->getX() + 32);
	_sprite->setX(_sprite->getX() + 32);
#endif
